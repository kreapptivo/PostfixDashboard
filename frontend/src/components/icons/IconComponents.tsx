...
export const Cog6ToothIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9.594 3.94c.09-.542.56-1.003 1.11-1.226.554-.223 1.197-.245 1.753.05l4.318 2.261a2.25 2.25 0 011.282 2.064v3.834a2.25 2.25 0 01-1.09 1.984l-4.158 2.376a2.25 2.25 0 01-2.132 0l-4.158-2.376a2.25 2.25 0 01-1.09-1.984V7.06a2.25 2.25 0 011.282-2.064l4.318-2.261z"
    />
...
export const ComputerDesktopIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9 17.75v1.007a3 3 0 01-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0115 18.257V17.25m6-12V15a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 15V5.25A2.25 2.25 0 015.25 3h13.5A2.25 2.25 0 0121 5.25z"
    />
  </svg>
);
...
export const ShieldExclamationIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 9v3.75m0-10.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.75c0 5.592 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.57-.598-3.75h-.152c-3.196 0-6.1-1.249-8.25-3.286zm0 13.036h.008v.008h-.008v-.008z"
    />
  </svg>
);
